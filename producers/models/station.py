...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        topic_name = f"{station_name}.org.chicago.cta.station.arrivals"
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        # logger.info(f"!--{self.station_id}-- is a Station id")
        # logger.info(f"{train.train_id} is a TRAIN id")
        # logger.info(f"{direction} is Direction")
        # logger.info(f"{self.color.name} is a Line color")
        # logger.info(f"{train.status.name} is Train status")
        # logger.info(f"{prev_station_id} is Prev_station_id")
        # logger.info(f"{prev_direction} is Prev_direction")
